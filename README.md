...
NEEDS ENGINE - Does not support JSON but supports "parsable" format which could easily be turned into JSON and shaped into CodeClimate JSON format
...
```
cd existing_repo
git remote add origin https://gitlab.com/megabyte-labs/docker/codeclimate/yamllint.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:ebd84bea9599be6dfad6c1facd29ad57?https://gitlab.com/megabyte-labs/docker/codeclimate/yamllint/-/settings/integrations)
